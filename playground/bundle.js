...
perc.note.seq( gen( cycle(2) * 7 ), Hex(0x8036) )
perc.note.seq( gen( 7 + cycle(2.25) * 4 ), Hex(0x4541), 1 )
 
bass = Monosynth('bassPad').connect( verb, .5 )
...
lead = Synth( 'cry', { gain:.1 })
lead.connect( verb, 1 )
lead.octave = 1
lead.note.seq( gen( cycle(.15) * 7 ), [1/2,1,2] )`
